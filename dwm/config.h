...
static const char *firefox[]  = { "zen-browser-optimized", NULL };
static const char *nautilus[]  = { "st","ranger", NULL };

// Function Commands
static const char *volmore[] = { "amixer","sset","Master","5%+",NULL };
static const char *volless[] = { "amixer","sset","Master","5%-",NULL };
...
static const Key keys[] = {
	...
	{ 0,				XF86XK_AudioRaiseVolume, 	spawn, {.v = volmore } },
	{ 0,				XF86XK_AudioLowerVolume, 	spawn, {.v = volless } },
	{ 0,				XF86XK_AudioMute, 		spawn, {.v = volmute } },
	{ 0,				XF86XK_AudioMicMute, 		spawn, {.v = micmute } },
	{ 0,				XF86XK_MonBrightnessUp, 	spawn, SHCMD("$HOME/suckless/slstatus/scripts/bninc.sh") },
